...
def TaskExe():
    ...
    def OpenApps():
        ...
        if 'code' in query:
            os.startfile("C:\\Users\\saumy\\OneDrive\\Desktop\\code")
            ...
            os.startfile("C:\\Users\\saumy\\OneDrive\\Desktop\\Unity Hub")
